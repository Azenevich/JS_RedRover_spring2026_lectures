...
// // нам нужно взять значение ключа city но мы не знаем существует ли оно или существует ли ключ
// // address вообще. как быть?
...
/*
Как правило, методу объекта требуется доступ к информации, хранящейся в объекте,
для выполнения своей работы.

Например, коду внутри person.greetings() может потребоваться имя или возраст, которое
хранится в объекте person.
